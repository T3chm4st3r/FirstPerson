...
public class PlayerMovementScript : MonoBehaviour
{
    ...
    private AudioClip[] silentClips = default;
    public bool isSprinting = false;
    public bool isCrouching = false;
    private float footstepTimer = 0;
    private float GetCurrentOffset => isSprinting ? baseStepSpeed * SprintMultiplier : isCrouching ? baseStepSpeed * CrouchMultiplier : baseStepSpeed;
